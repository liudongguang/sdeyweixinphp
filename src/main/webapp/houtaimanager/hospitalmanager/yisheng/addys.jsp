...
<div class=" paddingTop45">
	<form id="submitForm" class="form-inline"
		...
		<div class="form-group">
			<label class="mytext1">所在科室</label> <select name="ssksid"
				class="form-control"
				ajaxURL="hospitalmanager/getKeshiListNoPage">
			</select> <input type="hidden" id="ssksid_input" value="${obj.ssksid}" />
		</div>
		<br />
		<div class="form-group">
	...
	<script type="text/javascript"
		src="assets/js/houtaimanager/hospitalmanager/yisheng/add.js"></script>
</div>