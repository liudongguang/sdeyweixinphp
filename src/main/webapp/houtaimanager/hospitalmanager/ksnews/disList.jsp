...
<div class="containtH800">
	<button class="btn btn-success addbutton" notTanchu_title
		myurl="/houtaimanager/hospitalmanager/ksnews/add.jsp" title="新增科室新闻"
		width="800" height="400">新增</button>
	...
	<div id="pageDIV" class="text-center">
		<c:if test="${page!=null}">
			<page:createPager pages="${page.pages}" pageSize="${page.pageSize}"
				url="/hospitalmanager/getKsNewsListForHospitalManager" total="${page.total}"
