...
<div class="paddingTop45">
	<form id="submitForm" action="hospitalmanager/addKsNews" method="post"
		...
		<div class="form-group">
			<label class="mytext1">所在科室</label> <select name="ksid"
				class="form-control" ajaxURL="hospitalmanager/getKeshiListNoPage">
			</select> <input type="hidden" id="ksid_input" value="${obj.ksid}" />
		</div>
		<br />
		<div class="form-group">
	...
	<script type="text/javascript"
		src="assets/js/houtaimanager/hospitalmanager/ksnews/add.js"></script>
</div>