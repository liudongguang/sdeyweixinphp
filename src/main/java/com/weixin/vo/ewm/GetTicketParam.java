...
public class GetTicketParam {
	private Long expire_seconds;// 该二维码有效时间，以秒为单位。
	...
	public String toString() {
		return "GetTicketParam [expire_seconds=" + expire_seconds + ", action_name=" + action_name + ", action_info="
				+ action_info + ", scene_id=" + scene_id + ", scene_str=" + scene_str + "]";
	}
